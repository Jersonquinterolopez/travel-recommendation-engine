...
import { DialogBox, DividerVerticalLine } from "./styledComponents";
      ...
      <DialogBox>
        <form onSubmit={handleSubmit}>
          ...
          <Flex m={"10px"}>
            <button
              type="button"
              onClick={() => setUserPreferences("Where Can I Eat in:")}
            ...
            <button
              type="button"
              onClick={() => setUserPreferences("Where Can I play golf in:")}
              className="bg-gray-600 m-1 hover:bg-cyan-600 text-white font-bold py-2 px-4 rounded w-full"
            >
            ...
            <button
              type="button"
              onClick={() => setUserPreferences("Where Can I dance in:")}
              className="bg-gray-600 m-1 hover:bg-cyan-600 text-white font-bold py-2 px-4 rounded w-full"
            >
              🕺🏻 Where Can I dance:{" "}
            </button>
